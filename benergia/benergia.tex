...
Per calibrar la bomba hem fet un seguit de mesures dels volums omplerts per aquesta corresponents a una sèrie de valors de revolucions per minut (rpm) en un temps $t = 3$ min. Els valors obtinguts es poden veure a \ref{fig1}.
