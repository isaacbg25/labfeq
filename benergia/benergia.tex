...
Observem que obtenim unes rectes prou bones, fet que ens indica que les dades experimentals es comporten de forma similar a la predicció teòrica. Si, a més, comparem els valors de les pendents amb el valor esperat ${-Q_L}/{2,303V}$:
