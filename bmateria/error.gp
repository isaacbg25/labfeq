...
set title "Error relatiu concentració al llarg del temps pel cabal de 270.16 mL/min"

set xrange[0:2340]
set yrange[0:100]

plot "error.txt" u 1:2 w l ls 1 t 'cabal = 270.16 mL/min'
...
set title "Error relatiu concentració pel cabal de 491.42 mL/min"

plot "error.txt" u 1:3 w l ls 2 t 'cabal = 491.42 mL/min'