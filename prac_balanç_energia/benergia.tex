...
Per calibrar la bomba hem fet un seguit de mesures dels cabals corresponents als valors de revolucions per minut (rpm) donats per la bomba, tot calculant la quanitat de volum expedida en un temps de 3 minuts
\begin{equation}
    Q_L = \frac{V}{t}
\end{equation}
Els resultats del calibratge es poden veure a \ref{fig1}
\begin{figure}
    \includegraphics{calbomba.png}
